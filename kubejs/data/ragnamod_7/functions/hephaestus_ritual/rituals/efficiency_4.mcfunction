...
function ragnamod_7:hephaestus_ritual/items/minecraft_diamond
function ragnamod_7:hephaestus_ritual/items/forbidden_arcanus_ender_pearl_fragment
function ragnamod_7:hephaestus_ritual/items/minecraft_lapis_lazuli
