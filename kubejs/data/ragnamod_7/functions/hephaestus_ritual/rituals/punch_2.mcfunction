...
function ragnamod_7:hephaestus_ritual/items/minecraft_slime_ball
function ragnamod_7:hephaestus_ritual/items/minecraft_iron_ingot
function ragnamod_7:hephaestus_ritual/items/minecraft_stick
