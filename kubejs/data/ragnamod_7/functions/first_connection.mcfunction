...
execute unless score @s FirstConnection matches 0 unless score @s FirstConnection matches 2 run advancement grant @s only ragnamod_7:first_connection_land
scoreboard objectives remove FirstConnection
tp @s[tag=FirstConnectionFall] ~ 255 ~
execute if entity @s[tag=FirstConnectionFall] run schedule function ragnamod_7:first_connection_fall 1t replace
