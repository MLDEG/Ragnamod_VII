...
onEvent('recipes', e => {
    ...
    /**************************Blocks************************************/
    //Silver
    stoneCutter('darkerdepths:silver_block', [{ "item": 'occultism:silver_block' }, { "item": 'immersiveengineering:storage_silver' }, { "item": 'thermal:silver_block' }])
    stoneCutter('occultism:silver_block', [{ "item": 'darkerdepths:silver_block' }, { "item": 'immersiveengineering:storage_silver' }, { "item": 'thermal:silver_block' }])
    stoneCutter('immersiveengineering:storage_silver', [{ "item": 'darkerdepths:silver_block' }, { "item": 'occultism:silver_block' }, { "item": 'thermal:silver_block' }])
    stoneCutter('thermal:silver_block', [{ "item": 'darkerdepths:silver_block' }, { "item": 'occultism:silver_block' }, { "item": 'immersiveengineering:storage_silver' }])
    //Lead
    stoneCutter('ftbic:lead_block', [{ "item": 'mekanism:block_lead' }, { "item": 'immersiveengineering:storage_lead' }, { "item": 'thermal:lead_block' }])
    stoneCutter('mekanism:block_lead', [{ "item": 'ftbic:lead_block' }, { "item": 'immersiveengineering:storage_lead' }, { "item": 'thermal:lead_block' }])
    stoneCutter('immersiveengineering:storage_lead', [{ "item": 'ftbic:lead_block' }, { "item": 'mekanism:block_lead' }, { "item": 'thermal:lead_block' }])
    stoneCutter('thermal:lead_block', [{ "item": 'ftbic:lead_block' }, { "item": 'mekanism:block_lead' }, { "item": 'immersiveengineering:storage_lead' }])
    //Uranium
    stoneCutter('ftbic:uranium_block', [{ "item": 'immersiveengineering:storage_uranium' }, { "item": 'mekanism:block_uranium' }])
    stoneCutter('immersiveengineering:storage_uranium', [{ "item": 'ftbic:uranium_block' }, { "item": 'mekanism:block_uranium' }])
    stoneCutter('mekanism:block_uranium', [{ "item": 'ftbic:uranium_block' }, { "item": 'immersiveengineering:storage_uranium' }])
    //Tin
    stoneCutter('ftbic:tin_block', [{ "item": 'mekanism:block_tin' }, { "item": 'thermal:tin_block' }])
    stoneCutter('mekanism:block_tin', [{ "item": 'ftbic:tin_block' }, { "item": 'thermal:tin_block' }])
    stoneCutter('thermal:tin_block', [{ "item": 'ftbic:tin_block' }, { "item": 'mekanism:block_tin' }])
    //Steel
    ...
    //Aluminum
    stoneCutter('ftbic:aluminum_block', [{ "item": 'immersiveengineering:storage_aluminum' }, { "item": 'tinkers_reforged:aluminum_block' }])
    stoneCutter('immersiveengineering:storage_aluminum', [{ "item": 'ftbic:aluminum_block' }, { "item": 'tinkers_reforged:aluminum_block' }])
    stoneCutter('tinkers_reforged:aluminum_block', [{ "item": 'ftbic:aluminum_block' }, { "item": 'immersiveengineering:storage_aluminum' }])
    //Constantan
