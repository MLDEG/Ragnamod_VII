onEvent('recipes', e => {
  ...
  advEphae('ragnamod_seven:infinity_nugget', 'byg:subzero_crystal_shard', 'blue_skies:moonstone', 'ae2:certus_quartz_crystal', 'gemsnjewels:aquamarine', 'occultism:soul_gem', 'minecraft:diamond', 'ragnamod_seven:cyan_gem', 0, 25, 0)
