onEvent('recipes', e => {
  ...
  advEphae('ragnamod_seven:infinity_nugget', 'gemsnjewels:garnet', 'miningmaster:spirit_garnet', 'gemsnjewels:spinel', 'redstone_arsenal:flux_gem', 'blue_skies:pyrope_gem', 'gemsnjewels:tourmaline', 'ragnamod_seven:red_gem', 0, 25, 0)
  advEphae('ragnamod_seven:infinity_nugget', 'tinkers_reforged:hureaulite_gem', 'miningmaster:kinetic_opal', 'miningmaster:lucky_citrine', 'gemsnjewels:topaz', 'gemsnjewels:citrine', 'miningmaster:power_pyrite', 'ragnamod_seven:yellow_gem', 0, 25, 0)
  advEphae('ragnamod_seven:infinity_nugget', 'gemsnjewels:emerald', 'ars_nouveau:experience_gem', 'gemsnjewels:peridot', 'blue_skies:diopside_gem', 'minecraft:emerald', 'miningmaster:divine_beryl', 'ragnamod_seven:green_gem', 0, 25, 0)
  advEphae('ragnamod_seven:infinity_nugget', 'byg:subzero_crystal_shard', 'blue_skies:moonstone', 'ae2:certus_quartz_crystal', 'gemsnjewels:aquamarine', 'occultism:soul_gem', 'botania:mana_diamond', 'ragnamod_seven:cyan_gem', 0, 25, 0)
  advEphae('ragnamod_seven:infinity_nugget', 'miningmaster:unbreaking_iolite', 'gemsnjewels:tanzanite', 'miningmaster:dive_aquamarine', 'gemsnjewels:alexandrite', 'gemsnjewels:zircon', 'miningmaster:ice_sapphire', 'ragnamod_seven:blue_gem', 0, 25, 0)
  advEphae('ragnamod_seven:infinity_nugget', 'gemsnjewels:amethyst', 'create:rose_quartz', 'gemsnjewels:morganite', 'gemsnjewels:kunzite', 'miningmaster:heart_rhodonite', 'botania:dragonstone', 'ragnamod_seven:purple_gem', 0, 25, 0)
  advEphae('ragnamod_seven:infinity_nugget', 'miningmaster:spider_kunzite', 'psi:psigem', 'mekanism:fluorite_gem', 'forbidden_arcanus:arcane_crystal', 'gemsnjewels:opal', 'gemsnjewels:pale_diamond', 'ragnamod_seven:white_gem', 0, 25, 0)
